            ...
            <div class="bg-white shadow-xl rounded-2xl p-6 border border-gray-100 sticky top-8">
                ...
                <form action="{{ route('alumnos.store') }}" method="POST" class="space-y-4">
                    ...
                    <div>
                        ...
                        <input type="text" name="nombre" class="w-full border border-gray-300 rounded-lg px-4 py-2 focus:ring-2 focus:ring-blue-500/20 outline-none" placeholder="Ej. Juan Pérez" required>
                    </div>

                    <div>
                        <label class="block text-sm font-semibold text-gray-700 mb-1">Matrícula:</label>
                        <input type="text" name="matricula" class="w-full border border-gray-300 rounded-lg px-4 py-2 focus:ring-2 focus:ring-blue-500/20 outline-none" placeholder="20240001" required>
                    </div>

                    <div>
                        <label class="block text-sm font-semibold text-gray-700 mb-1">Carrera:</label>
                        <select name="carrera" class="w-full border border-gray-300 rounded-lg px-4 py-2 bg-white focus:ring-2 focus:ring-blue-500/20 outline-none cursor-pointer" required>
                    ...
                    <div>
                        ...
                        <input type="email" name="email" class="w-full border border-gray-300 rounded-lg px-4 py-2 focus:ring-2 focus:ring-blue-500/20 outline-none" placeholder="alumno@universidad.edu" required>
                    </div>

                    <div>
                        <label class="block text-sm font-semibold text-gray-700 mb-1">Teléfono:</label>
                        <input type="text" name="telefono" class="w-full border border-gray-300 rounded-lg px-4 py-2 focus:ring-2 focus:ring-blue-500/20 outline-none" placeholder="999 000 0000" required>
                    </div>
                    ...
                    <table class="w-full text-sm text-left">
                        ...
                        <tbody class="divide-y divide-gray-100">
                            ...
                            <tr class="hover:bg-blue-50/50 transition-colors">
                                ...
                                <td class="p-4">
                                    <p class="font-bold text-gray-800">{{ $alumno->nombre }}</p>
                                    <p class="text-xs text-blue-600">{{ $alumno->email }}</p>
                                </td>
                                ...
                                <td class="p-4 text-center">
                                    <div class="flex justify-center gap-2">
                                        ...
                                        <form action="{{ route('alumnos.destroy', $alumno) }}" method="POST" onsubmit="return confirm('¿Eliminar a este alumno?')">
                                            @csrf @method('DELETE')
